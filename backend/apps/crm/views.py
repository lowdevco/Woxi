...
class WhatsAppWebhookView(APIView):
    ...
    def post(self, request):
        ...
        sender_name = contacts[0].get('profile', {}).get(
            'name', 'WhatsApp Customer') if contacts else 'WhatsApp Customer'
        ...
        message = Message.objects.create(
            ...
            content_type=msg_type if msg_type in [
                'text', 'image', 'document', 'audio', 'video', 'location', 'template'] else 'text',
