...
import { 
  ...
  IconButton, ListItem, ListItemButton, ListItemIcon, ListItemText, Avatar, Button, Menu, MenuItem
} from '@mui/material';
import { 
  FiMenu as MenuIcon, 
            ...
            <ListItem key={item.text} disablePadding sx={{ mb: 0.5 }}>
              <ListItemButton 
                ...
                sx={{
                  ...
                  '&:hover': {
                    bgcolor: active ? 'rgba(16, 185, 129, 0.12)' : 'action.hover',
                  },
                }}
              >
                ...
                <ListItemText 
                  ...
                  primaryTypographyProps={{ fontWeight: active ? 700 : 500, fontSize: '14px' }} 
                />
              </ListItemButton>
            </ListItem>
          );
      ...
      >
        <Toolbar sx={{ justifyContent: 'space-between', px: 3 }}>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
            <IconButton onClick={toggleTheme} color="inherit" title={mode === 'dark' ? 'Switch to Light Mode' : 'Switch to Dark Mode'} sx={{ p: 1 }}>
