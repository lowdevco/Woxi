  ...
  useEffect(() => {
    ...
    const fetchStats = async () => {
      try {
        ...
        const totalValue = deals.data.reduce((acc, deal) => acc + parseFloat(deal.value || 0), 0);
    ...
    <Box>
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 4 }}>
        <Box>
          ...
          <Typography variant="subtitle1" color="text.secondary">Here is an overview of your WhatsApp CRM performance.</Typography>
        </Box>
        <Button 
          variant="contained" 
          startIcon={<WhatsApp />} 
